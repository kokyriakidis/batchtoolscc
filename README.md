...
**The most important feature of batchtools_cc package is that you do not have to configure it for your HPC system. Everything is automatically set and ready to run.**
